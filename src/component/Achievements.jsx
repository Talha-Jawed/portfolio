...
class Achievements extends Component {
    constructor(props) {
        ...
        this.state = {
            arr: [
                { img: mernStack, cardName: 'MERN Stack Developer', cardDetail: 'Certified Mobile and Web App Developer from SMIT.', url: 'https://drive.google.com/file/d/1zG9-32rYGH_UyxlZEPp9zopQXIqykzte/view' },
                { img: cssJs, cardName: 'HTML, CSS, JAVASCRIPT', cardDetail: 'Completed Certification from SoloLearn Online Certificates.', url: 'https://docs.google.com/document/d/1M4eizHf59opxN_nI9eFGvrb7PtK6RB1rjSvOh0UT9fI/edit' },
                { img: pwa, cardName: 'PWA Web App Developer', cardDetail: 'Completed Certification from SMIT for PWA Web App Development.', url: 'https://drive.google.com/file/d/1sHtwUcT5yks7XTN24oQpDwIyiPxHnn3r/view' },
                { img: mongoDB, cardName: 'MongoDB Certificate', cardDetail: 'Completed Certification from MongoDB University for MongoDB Basics.', url: 'http://university.mongodb.com/course_completion/9d58d436-974e-47ef-bf01-d3ce51df6634' },
